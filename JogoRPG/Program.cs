...
class Program
{
    ...
    class Jogo
    {
        ...
        public void TelaCadastro()
        {
            ...
            Console.WriteLine("Bem-vindos ao LuRPG!");
            Console.WriteLine();
        ...
        {
            Console.ForegroundColor = ConsoleColor.Red;
            Console.WriteLine("Tela de login - LuRPG");
            Console.ResetColor();
            Console.WriteLine();
        ...
        public void EscolherMontaria()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Finalizando cadastro LuRPG");
            for (int i = 5; i > 0; i--)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.Write("... " + i);
        ...
        {
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("Parabéns, você finalizou seu cadastro no LuRPG!");
            Console.WriteLine();
